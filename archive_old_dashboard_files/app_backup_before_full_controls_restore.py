...
st.set_page_config(page_title="ADAPT Rescue Clean", layout="wide", initial_sidebar_state="collapsed")
...
st.markdown(
    ...
    <div class="hero">
      ...
      <div style="color:#94a3b8;margin-top:6px;">Rescue clean build using allocator_state for COMBINED state display.</div>
    </div>
    """,
    unsafe_allow_html=True,
)
...
if run:
    ...
    st.info("Run Backtest to load the rescue clean dashboard.")
