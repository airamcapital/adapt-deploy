...
st.markdown(
    ...
    .hero { background: linear-gradient(135deg, #0f172a 0%, #111f3d 100%); border: 1px solid #334155; border-radius: 18px; padding: 24px 20px 20px 20px; margin-bottom: 16px; overflow: visible; }
    .metricbox { background: #0f172a; border: 1px solid #334155; border-radius: 14px; padding: 12px 14px; min-height: 132px; display:flex; flex-direction:column; justify-content:flex-start; }
    .metrichead { display:flex; align-items:center; justify-content:space-between; gap:8px; }
    .metriclabel { color:#94a3b8; font-size:0.80rem; text-transform:uppercase; letter-spacing:0.08em; }
    .metricvalue { color:white; font-size:1.55rem; font-weight:700; margin-top:6px; }
    .metricsub { color:#94a3b8; font-size:0.92rem; margin-top:6px; line-height:1.3; }
...
st.markdown(
    ...
    <div class="hero">
      ...
      <h1 style="margin:8px 0 6px 0;">Institutional Strategy Terminal</h1>
      <div style="color:#94a3b8;font-size:1.05rem;">Institutional analytics for the ADAPT CORE + ALPHA system. Display layer only — preserves the validated ADAPT engine workflow and return stream calculations.</div>
    </div>
    """,
    unsafe_allow_html=True,
)
