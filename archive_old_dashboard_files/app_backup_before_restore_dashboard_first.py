...
if run:
    ...
    with right:
        alloc_tooltip = (
            "This table shows the current live allocation for the selected strategy and date range end-point. "
            "For COMBINED, the allocator state determines the mix.<br><br>"
